...
Open [https://build-it-la.herokuapp.com](https://build-it-la.herokuapp.com) to view it in the browser.
...
```
Fetch API cannot load http://localhost:4000/api/todos. No 'Access-Control-Allow-Origin' header is present on the requested resource. Origin 'https://build-it-la.herokuapp.com' is therefore not allowed access. If an opaque response serves your needs, set the request's mode to 'no-cors' to fetch the resource with CORS disabled.
```
